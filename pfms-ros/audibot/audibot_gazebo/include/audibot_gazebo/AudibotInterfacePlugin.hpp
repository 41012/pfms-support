...
namespace audibot_gazebo {
        ...
        public ISystemPostUpdate
    {
        ...
        private:
            ...
            uint64_t speed_cmd_stamp_ = UINT64_MAX;
            uint64_t brake_cmd_stamp_ = UINT64_MAX;
            uint64_t throttle_cmd_stamp_ = UINT64_MAX;
            ...
            uint64_t steering_cmd_stamp_ = UINT64_MAX;
