...
def generate_launch_description():
    pkg_share = FindPackageShare(package='sjtu_drone_description').find('sjtu_drone_description')
    urdf_file = os.path.join(pkg_share, 'urdf/sjtu_drone.urdf.xacro')
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{
                ...
                'robot_description': Command([f'xacro {urdf_file} pub_tf:=', LaunchConfiguration('pub_tf'), ' robot_name:=', LaunchConfiguration('robot_name')])
            }]),
        Node(
            package='gazebo_ros',
